...
<footer className="bg-[#212721]">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div>
        <h2 className="mb-6 text-lg font-semibold text-gray-100 uppercase">Kepler BBC first team</h2>
      ...
      <div className="mb-6 md:pb-12">
              <a href="" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-100">Kepler sports</span>
              </a>
          </div>
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-md text-gray-200 sm:text-center font-bold">© copyright <a href="" className="hover:underline font-bold">Kepler sports™</a>. All Rights Reserved.
          </span>
